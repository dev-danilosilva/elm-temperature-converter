...
var $author$project$Temperature$Temperature = F2(
	function (unit, scalar) {
		return {scalar: scalar, unit: unit};
	});
var $author$project$Temperature$C = {$: 'C'};
var $author$project$Main$initialFromUnit = $author$project$Temperature$C;
var $author$project$Main$initialScalar = 0;
var $author$project$Main$initialFromTemperature = A2($author$project$Temperature$Temperature, $author$project$Main$initialFromUnit, $author$project$Main$initialScalar);
...
var $author$project$Temperature$convertFrom = F3(
	function (u0, u1, t0) {
		switch (u0.$) {
			case 'K':
				switch (u1.$) {
...
var $author$project$Main$initialToTemperature = A2(
	...
	A3($author$project$Temperature$convertFrom, $author$project$Main$initialFromUnit, $author$project$Main$initialToUnit, $author$project$Main$initialScalar));
...
var $author$project$Temperature$unitFromString = function (u) {
	var _v0 = $elm$core$String$toUpper(u);
	switch (_v0) {
		case 'K':
			return $elm$core$Maybe$Just($author$project$Temperature$K);
		case 'F':
			return $elm$core$Maybe$Just($author$project$Temperature$F);
		case 'C':
			return $elm$core$Maybe$Just($author$project$Temperature$C);
		case 'Kelvin':
			return $elm$core$Maybe$Just($author$project$Temperature$K);
		case 'Fahrenheit':
			return $elm$core$Maybe$Just($author$project$Temperature$F);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeFromScalar':
				var t = msg.a;
				var _v1 = $elm$core$String$toFloat(t);
				if (_v1.$ === 'Nothing') {
					return _Utils_update(
						model,
						{
							from: A2($author$project$Temperature$Temperature, model.from.unit, $author$project$Main$initialScalar),
							to: A2(
								$author$project$Temperature$Temperature,
								model.to.unit,
								A3($author$project$Temperature$convertFrom, model.from.unit, model.to.unit, $author$project$Main$initialScalar))
						});
				} else {
					var scalar = _v1.a;
					return _Utils_update(
						model,
						{
							from: A2($author$project$Temperature$Temperature, model.from.unit, scalar),
							to: A2(
								$author$project$Temperature$Temperature,
								model.to.unit,
								A3($author$project$Temperature$convertFrom, model.from.unit, model.to.unit, scalar))
						});
				}
			case 'ChangeFromUnit':
				var u = msg.a;
				var _v2 = $author$project$Temperature$unitFromString(u);
				if (_v2.$ === 'Nothing') {
					return model;
				} else {
					var unit = _v2.a;
			...
			default:
				var u = msg.a;
				var _v3 = $author$project$Temperature$unitFromString(u);
				if (_v3.$ === 'Nothing') {
					return model;
				} else {
					var toUnit = _v3.a;
						...
						_Utils_update(
							model,
							{
								to: A2(
									$author$project$Temperature$Temperature,
									toUnit,
									A3($author$project$Temperature$convertFrom, model.from.unit, toUnit, model.from.scalar))
							}));
				}
		}
	});
var $author$project$Main$ChangeFromScalar = function (a) {
	return {$: 'ChangeFromScalar', a: a};
};
var $author$project$Main$ChangeFromUnit = function (a) {
	return {$: 'ChangeFromUnit', a: a};
};
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{
		init: A2($author$project$Main$Model, $author$project$Main$initialFromTemperature, $author$project$Main$initialToTemperature),
